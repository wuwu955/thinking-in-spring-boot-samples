...
public class ConditionalOnSystemPropertyBootstrap {
    ...
    public static void main(String[] args) {
        ...
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext("thinking.in.spring.boot.samples.spring4.config");
        // 注册 配置Bean ConditionalMessageConfiguration 到 Spring 上下文
//        context.register(ConditionalMessageConfiguration.class);
        // 启动上下文 如果时有参构造的就不用在刷新了
//        context.refresh();
